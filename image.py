...
def openimage():
    modelpath = "D:/网络下载/emoji-creator-project-code/emoji-creator-project-code/emotion_model.h5"
    weightpath = "D:/网络下载/emoji-creator-project-code/emoji-creator-project-code/emotion_model.h5"

    emo_labels = ['Surprise', 'Fear', 'Disgust', 'Happy', 'Sad', 'Anger', 'Neutral']

    deploy_model = emotion_model()(deploy=True)
    # deploy_model.load_state_dict(torch.load('train_model_20.pth'))
    deploy_model.load_state_dict({k.replace('module.', ''): v for k, v in torch.load('D:/网络下载/emoji-creator-project-code/emoji-creator-project-code/emotion_model.h5').items()})
    ...
    dlg.SetOFNInitialDir('"D:/Emoji Recognition/test/disgust/PrivateTest_3838250.jpg"')
    dlg.DoModal()
